...
object Utils {
  ...
  def main(args: Array[String]) {
    ...
    val cachedChannelFutures = scala.collection.mutable.Map[InetSocketAddress, String]()
    cachedChannelFutures += Host("127.0.0.1", 8080).socketAddress -> "Hello"

    println(cachedChannelFutures.get(Host("localhost", 8080).socketAddress))
